...
public class ButtonFrame extends JFrame implements ActionListener {
    ...
    public ButtonFrame(int p) {
        ...
        try {
            final Image backgroundImage = javax.imageio.ImageIO.read(new File("newfulk.jpg"));
        ...
        wordPoint.setFont(new Font("DialogInput", Font.BOLD, 70));
    ...
    public static void main(String[] args) {
        ButtonFrame b = new ButtonFrame(1);
    }
            ...
            if (!finished){
                ...
                if (result == 1) {
                    if (submittedWords.contains(board.getWord())){
                        wordPoint.setText("You already submitted this word");
                        clearBoard();
                        reset(board);
                    }
                    else{
                    ...
                    wordPoint.setText("Words must be 3 or more characters!");
                    clearBoard();
                    reset(board);
                } else if (result == 3) {
